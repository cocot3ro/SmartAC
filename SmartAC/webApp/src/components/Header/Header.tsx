    ...
    return (
        <header className="navbar navbar-expand-md d-print-none">
            <div className="container-xl">
                ...
                <a href="." aria-label="Tabler" className="navbar-brand navbar-brand-autodark me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="110" height="32" viewBox="0 0 232 68"
                        ...
                        <path
                            ...
                            fillRule="evenodd" clipRule="evenodd" fill="#4a4a4a"
                            style={{fill: "var(--tblr-navbar-logo-color, #4a4a4a)"}}/>
                    </svg>
                </a>

                <div className="collapse navbar-collapse" id="navbar-menu">
                    <ul className="navbar-nav">
                        <NavLink icon={IconHome} title={t("Home")} onClick={() => navigate("/home")}/>
                        <NavLink icon={IconUser} title={t("Users")} onClick={() => navigate("/users")}/>
                        <NavLink icon={IconCpu} title={t("Devices")} onClick={() => navigate("/devices")}/>
                        <NavLink icon={IconSettings} title={t("Settings")} onClick={() => navigate("/settings")}/>
                    </ul>
                </div>
            </div>
        </header>
